...
public class AnexosMedicaoSsDTOComparator implements Comparator<AnexosMedicaoSsDTO> {

	private final String campo;
	private final String ordem;
	
	public AnexosMedicaoSsDTOComparator(String campo, String ordem) {
		this.campo = campo;
		this.ordem = ordem;
	}
	
	@Override
	public int compare(AnexosMedicaoSsDTO o1, AnexosMedicaoSsDTO o2) {
