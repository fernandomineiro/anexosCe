...
public class AnexosSsGenericoDTOComparator  implements Comparator<AnexosSsGenericoDTO>  {

	private final String campo;
	private final String ordem;
	
	public AnexosSsGenericoDTOComparator(String campo, String ordem) {
		this.campo = campo;
		this.ordem = ordem;
	}
	
	@Override
	public int compare(AnexosSsGenericoDTO o1, AnexosSsGenericoDTO o2) {
