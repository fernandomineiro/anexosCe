...
public class AnexosMedicaoSsDTO {
    ...
    public AnexosMedicaoSsDTO() {
		
	}
	public AnexosMedicaoSsDTO(Integer tamanhoArquivo) {
		this.tamanhoArquivo = tamanhoArquivo;
	}
	
	

	public AnexosMedicaoSsDTO(Long id, LocalDateTime dataHoraInclusao,Integer codAtendimento,Integer refAtendimento,Short seqSS, String descricao, String usuario, String nomeArquivo, Integer tamanhoArquivo,
	...
	public AnexosMedicaoSsDTO(Long id, LocalDateTime dataHoraInclusao, String descricao, String usuario, String nomeArquivo,
			String acessoRestrito) {
		this.id = id;
		this.dataHoraInclusao = dataHoraInclusao;
		this.descricao = descricao;
