...
public class AnexosBaixarSolicitacaoServicoDTO {
	...
	public AnexosBaixarSolicitacaoServicoDTO(Long id, LocalDateTime dataHoraInclusao, Integer codAtendimento, Integer refAtendimento,
	...
	public AnexosBaixarSolicitacaoServicoDTO(Integer tamanhoArquivo) {
		this.tamanhoArquivo = tamanhoArquivo;
	}


	public AnexosBaixarSolicitacaoServicoDTO() {
		super();
	}
