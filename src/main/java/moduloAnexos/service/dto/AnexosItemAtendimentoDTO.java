...
public class AnexosItemAtendimentoDTO {
	...
	public AnexosItemAtendimentoDTO(Long id, LocalDateTime dataHoraInclusao, Integer codAtendimento,
			Integer refAtendimento, Short seqSS, String descricao, String usuario, String nomeArquivo,
	...
	public AnexosItemAtendimentoDTO(Integer tamanhoArquivo) {
		this.tamanhoArquivo = tamanhoArquivo;
	}

	public AnexosItemAtendimentoDTO() {
		super();
	}
